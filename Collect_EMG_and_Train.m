...
Trainable_Matrix = zeros(total_time/window, 7); 
...
%             WA_2 = 0;
%             for x = 1:window
%                 %change constants to a percentage of resting EMG
%                 %50
%                 if temp_EMG1(1,x) > mean(temp_EMG1) + 50
%                     WA_1 = WA_1 + 1;
%                 end
%                 %55
%                 if temp_EMG2(1, x) > mean(temp_EMG2) + 55
%                     WA_2 = WA_2 + 1;
%                 end
%             end
%                 
%             Trainable_Matrix(n/10, 7) = WA_1;
%             Trainable_Matrix(n/10, 8) = WA_2;
...
[trainedClassifier, validationAccuracy] = trainClassifier_6Features(Trainable_Matrix)
pause(2);
flushinput(bt);
flushoutput(bt);
